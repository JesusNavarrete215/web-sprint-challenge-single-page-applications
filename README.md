...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   useRouteMatch hook attemps to match the current URL.
1. How would you explain form validation to someone who has never programmed before?
   For validation is a way of making sure the password is a certain length or when the input is an email the user puts a valid email.
1. In 1-2 sentences, define end to end testing.
   End to end testing is used to run test through an application like a user would. Testing each button and input field to make sure everything is working properly and nothing will break.
